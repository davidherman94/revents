...
In this study, with constant relapse rate (see [descriptive analyses](./descriptive_analyses.html)), the use of NB model can be accurate and recommended also for its ability to account for overdispersion and heterogeneity. However, the NB model, as other count-based models, does not consider event timing.
