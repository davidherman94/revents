...
data_layout_2 <- 
  ...
  # fill in missing values by repeating the value of the last cell
    fill(PARAMCD, TSTOP, STATUS, SEVENT, DISEASE_COURSE, SEX, AGE, RACE,
...
```{r echo=TRUE}
save_data_layout <- function(data_layout, file_name) {
  file_path_data_csv <- paste0("C:/Users/david/revents/inst/", file_name, ".csv")
  
  write.csv(as.data.frame(data_layout), file_path_data_csv)
}

# Save the data layouts for future use
save_data_layout(data_layout_1, "data_layout_1")
save_data_layout(data_layout_2, "data_layout_2")
save_data_layout(data_layout_3, "data_layout_3")
```
